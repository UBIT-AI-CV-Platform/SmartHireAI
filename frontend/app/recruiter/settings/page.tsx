    ...
    return (
      <div className="p-4 md:p-8 lg:p-10 max-w-3xl mx-auto">
        <div className="bg-white dark:bg-[#2c2c2e] rounded-[1.5rem] shadow-[0_12px_40px_-12px_rgba(25,28,30,0.08)] border border-surface-container p-10 md:p-16 flex flex-col items-center justify-center text-center">
          <div className="w-16 h-16 rounded-2xl bg-red-50 dark:bg-red-500/15 flex items-center justify-center text-red-500 dark:text-red-300 mb-5"><Icon name="cloud_off" className="text-3xl" /></div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex items-center gap-2 px-4 py-3 bg-surface-container-low rounded-2xl text-on-surface-variant font-medium">
                <Icon name="mail" className="text-outline text-lg" /><span className="truncate">{email}</span><span className="ml-auto text-[10px] font-bold text-outline uppercase">Locked</span>
              </div>
            </div>
            <div>
              ...
              <div className="flex items-center gap-2 px-4 py-3 bg-surface-container-low rounded-2xl text-on-surface font-medium">
                <Icon name="work" className="text-primary text-lg" />Recruiter<span className="ml-auto text-[10px] font-medium text-outline normal-case">One email = one role</span>
              </div>
            </div>
            <div>
          ...
          <div className="space-y-3">
            ...
            {pwMsg && (
              <div className={`flex items-start gap-2 rounded-xl px-4 py-3 ${pwMsg.type === 'ok' ? 'bg-green-50 dark:bg-green-500/15 border border-green-200 dark:border-green-500/30' : 'bg-red-50 dark:bg-red-500/15 border border-red-200 dark:border-red-500/30'}`}>
                <Icon name={pwMsg.type === 'ok' ? 'check_circle' : 'error'} className={pwMsg.type === 'ok' ? 'text-green-500 dark:text-green-300' : 'text-red-500 dark:text-red-300'} />
