        ...
        {sent ? (
          <div className="text-center auth-pop">
            ...
            <p className="text-gray-600 dark:text-slate-300 text-xs md:text-sm mb-6">
              We&apos;ve sent a password reset link to <span className="font-semibold text-gray-800 dark:text-slate-200">{email}</span>.
          ...
          <>
            <div className="text-center mb-5">
              <h1 className="text-lg font-bold text-gray-900 dark:text-slate-100 mb-1">Forgot password?</h1>
              <p className="text-gray-600 dark:text-slate-300 text-xs md:text-sm">
