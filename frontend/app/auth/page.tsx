  ...
  return (
    <div className="relative min-h-screen bg-[#f7f9fb] dark:bg-[#1c1c1e] flex items-center justify-center p-3 sm:p-4 md:p-6 lg:p-8">
      ...
      <div className="w-full max-w-6xl flex flex-col lg:flex-row gap-0 rounded-2xl overflow-hidden shadow-2xl min-h-[90vh] lg:h-[90vh] auth-fade-up">
        ...
        <div className="hidden lg:flex lg:w-3/5 bg-gradient-to-br from-blue-50 via-purple-50 to-blue-50 dark:from-[#1c1c1e] dark:via-[#241d36] dark:to-[#1c1c1e] auth-animated-gradient overflow-hidden">
          <BrandingSide />
        </div>

        {/* Auth Forms Container - Right Side */}
        <div className="w-full lg:w-2/5 flex flex-col bg-gradient-to-br from-blue-50 via-purple-50 to-blue-50 dark:from-[#1c1c1e] dark:via-[#241d36] dark:to-[#1c1c1e] auth-animated-gradient text-gray-900 dark:text-slate-100 p-3 sm:p-4 md:p-5 lg:p-6 overflow-y-auto max-h-[90vh] lg:overflow-hidden lg:max-h-full">
          {/* Mobile: Logo Section */}
          ...
          <div className="pt-3 md:pt-4 shrink-0 auth-fade-up" style={{ animationDelay: '0.3s' }}>
            <div className="relative flex items-center gap-3 mb-3">
              <div className="flex-1 border-t border-gray-300/40 dark:border-white/10" />
              <span className="text-[9px] md:text-[10px] font-bold text-gray-500 dark:text-slate-400 uppercase tracking-wider whitespace-nowrap">Or continue with</span>
              <div className="flex-1 border-t border-gray-300/40 dark:border-white/10" />
            </div>
