...
export default function SocialButton({ provider }: SocialButtonProps) {
  ...
  return (
    ...
    <button
      type="button"
      onClick={handleClick}
      className="w-full flex items-center justify-center gap-2.5 py-2.5 rounded-lg font-semibold text-sm bg-white dark:bg-[#2c2c2e] border border-gray-200 dark:border-white/10 text-gray-700 dark:text-slate-200 hover:bg-gray-50 dark:hover:bg-white/10 hover:border-gray-300 dark:hover:border-white/20 active:scale-[0.99] transition-all"
    >
      {isGoogle ? (
        <>
