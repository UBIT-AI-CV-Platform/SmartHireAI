...
export default function SocialButton({ provider }: SocialButtonProps) {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className={`w-full flex items-center justify-center gap-3 py-2.5 md:py-3 rounded-lg font-semibold text-sm md:text-base transition-all duration-300 hover:shadow-lg ${
        isGoogle
