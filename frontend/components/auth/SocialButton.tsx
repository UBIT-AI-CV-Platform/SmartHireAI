...
export default function SocialButton({ provider }: SocialButtonProps) {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="w-full flex items-center justify-center gap-2.5 py-2.5 rounded-lg font-semibold text-sm bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 hover:border-gray-300 active:scale-[0.99] transition-all"
    >
      {isGoogle ? (
        <>
