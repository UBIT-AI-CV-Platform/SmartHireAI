  ...
  const steps = [
    {
      ...
      circleBg: 'bg-pink-200 dark:bg-pink-500/25',
      circleColor: 'text-pink-700 dark:text-pink-300',
      badgeBg: 'bg-white dark:bg-[#2c2c2e] border-pink-400 text-pink-700 dark:text-pink-300',
      icon: 'person_add',
    ...
    },
    {
      ...
      circleBg: 'bg-blue-200 dark:bg-sky-500/25',
      circleColor: 'text-blue-700 dark:text-sky-300',
      badgeBg: 'bg-white dark:bg-[#2c2c2e] border-blue-400 text-blue-700 dark:text-sky-300',
      icon: 'auto_awesome',
    ...
    },
    {
      ...
      circleBg: 'bg-orange-200 dark:bg-orange-500/25',
      circleColor: 'text-orange-700 dark:text-orange-300',
      badgeBg: 'bg-white dark:bg-[#2c2c2e] border-orange-400 text-orange-700 dark:text-orange-300',
      icon: 'travel_explore',
    ...
    },
    {
      ...
      circleBg: 'bg-purple-200 dark:bg-purple-500/25',
      circleColor: 'text-purple-700 dark:text-purple-300',
      badgeBg: 'bg-white dark:bg-[#2c2c2e] border-purple-400 text-purple-700 dark:text-purple-300',
      icon: 'rocket_launch',
