export default function CTASection() {
  return (
    <section className="max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-10">
      <div className="rounded-[2rem] p-8 md:p-12 text-center relative overflow-hidden vibrant-cta-gradient border border-indigo-100 dark:border-white/10 shadow-xl">
        {/* Background Blobs */}
